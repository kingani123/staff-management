        ...
        <div className="inside">
          ...
          <div className="right_body_section">
            ...
            <div className="card-body">
              <div className="heading"><h3>Staff List (Qualification Wise)</h3></div>
              ...
              <div className="user_table_area">
                <div className="table_header">
                  ...
                  <div style={{width: '40%'}}>Qualification</div>
                ...
                <div className="table_body">
                  ...
                  <div style={{width: '40%'}}>
                    <p className="mobile_heading">Qualification</p>
...
export default Qualificationwise;